...
products[0] = new Product("ABC-red", "Firm Grounds (Red)",  199.99);
products[1] = new Product("ABC-green", "Firm Grounds (Green)",  199.99);
products[2] = new Product("ABC-blue", "Firm Grounds (Blue)",  199.99);
products[3] = new Product("123-red", "Turf Shoes (Red)",    110.00);
products[4] = new Product("123-green", "Turf Shoes (Green)",    110.00);
products[5] = new Product("123-blue", "Turf Shoes (Blue)",    110.00);
products[6] = new Product("xyz-red", "Soft Grounds (Red)",  214.99);
products[7] = new Product("xyz-green", "Soft Grounds (Green)",  214.99);
products[8] = new Product("xyz-blue", "Soft Grounds (Blue)",  214.99);

products[9] = new Product("111-red", "Ball (red)",  25.00);
products[10] = new Product("111-green", "Ball (green)",  25.00);
products[11] = new Product("111-blue", "Ball (Blue)",  25.00);

products[12] = new Product("222-red", "Ball Pump (red)",  9.95);
products[13] = new Product("222-green", "Ball Pump (green)",  9.95);
products[14] = new Product("222-blue", "Ball Pump (Blue)",  9.95);

products[15] = new Product("333-red", "Agility Cones (red)",  20.00);
products[16] = new Product("333-green", "Agility Cones (green)",  20.00);
products[17] = new Product("333-blue", "Agility Cones (Blue)",  20.00);

products[18] = new Product("444-red", "Shin Guards (red)",  13.00);
products[19] = new Product("444-green", "Shin Guards (green)",  13.00);
products[20] = new Product("444-blue", "Shin Guards (Blue)",  13.00);

products[21] = new Product("555", "Water Bottle",  15.00);

products[22] = new Product("ddd-red", "Indoor Shoes (red)",  98.00);
products[23] = new Product("ddd-green", "Indoor Shoes (green)" ,  98.00);
products[24] = new Product("ddd-blue", "Indoor Shoes (Blue)",  98.00);

products[25] = new Product("777-red", "Pinnies (red)",  30.00);
products[26] = new Product("777-green", "Pinnies (green)" ,  30.00);
products[27] = new Product("777-blue", "Pinnies (Blue)",  30.00);

products[28] = new Product("001", "Barcelona Jersey",  70.00);

products[29] = new Product("002", "Manchester United Jersey",  70.00);
products[30] = new Product("003", "PSG Jersey",  70.00);
products[31] = new Product("004", "White Soccer Socks",  9.00);
products[32] = new Product("005", "Black Soccer Shorts",  39.00);
products[33] = new Product("006", "USA Jersey",  70.00);
...
var free_shipping_allowed = false;   // ship free if spending quota is met
